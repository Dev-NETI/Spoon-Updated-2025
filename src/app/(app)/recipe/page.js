...
function Page() {
    ...
    const ui = recipeState.loading ? (
        ...
        <div className='flex gap-5 min-w-screen'>
            ...
            <div className='flex flex-col w-3/12 bg-slate-100 rounded-md shadow-sm'>
                <div className='flex items-center bg-spoonblue text-white rounded-t-md px-4 py-2 font-semibold'>
                    Top 5 Most Popular Dishes
                </div>
                <div className='flex flex-col p-5 my-2 overflow-y-auto max-h-screen'>
                            ...
                            >
                                ...
                                >
                                    ...
                                    <div className='flex flex-col w-full'>
                                        ...
                                        <span className='px-2 py-1 text-xs bg-blue-950 text-white text-center rounded-md font-bold'>
