...
const Layout = ({ children }) => {
    ...
    return (
        <div className='min-h-screen bg-blue-800 items-center justify-center text-gray-900 antialiased flex'>
            {pathName != '/login' ? (
            ...
            <AuthCard
                logo={
                    <Link href='/login'>
                        <ApplicationLogo className='w-10 h-10 fill-current text-blue-800' />
                    </Link>
                }
